import { UserState } from './containers/Dashboard/UserDashboard/types';
...
import { userReducer } from './containers/Dashboard/UserDashboard/reducers';
import { userSaga } from './containers/Dashboard/UserDashboard/saga';
